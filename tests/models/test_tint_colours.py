"""
Tests for `mosaic.models.tint_colours`.
"""
...
from mosaic.models import get_default_tint_colours, TintColours
...
def test_get_default_tint_colours() -> None:
    ...
    """
    c = get_default_tint_colours(variables_path=Path("css/base/variables.css"))
