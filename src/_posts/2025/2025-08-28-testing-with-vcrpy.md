...
```python {"names":{"1":"httpx","2":"vcr","3":"test_example_domain","6":"resp"}}
import httpx
import vcr
...
```python {"names":{"3":"test_example_domain","4":"resp"}}
...
```python {"names":{"1":"os","2":"httpx","3":"vcr","4":"test_flickr_api","8":"api_key","12":"resp"}}
import os
...
```python {"names":{"1":"test_example_domain_with_decode","5":"resp"}}
...
```python {"names":{"1":"httpx","2":"pytest","3":"vcr","4":"TestExampleDotCom","5":"test_status_code","6":"resp","16":"test_status_code","17":"url","18":"status_code","19":"resp"}}
import httpx
import pytest
import vcr
...
```python {"names":{"3":"cassette_name","4":"request","8":"name"}}
@pytest.fixture
...
```python {"names":{"1":"TestExampleDotCom","2":"test_status_code","3":"cassette_name","7":"resp","26":"test_status_code","27":"url","28":"status_code","29":"cassette_name","33":"resp"}}
class TestExampleDotCom:
...
```python {"names":{"1":"test_flickr_api","5":"api_key","9":"resp"}}
def test_flickr_api():
    with vcr.use_cassette(
        "fixtures/vcr_cassettes/test_flickr_api.yml",
        filter_query_parameters=[("api_key", "REDACTED_API_KEY")],
...
```python {"names":{"1":"check_for_invalid_api_key","2":"response","3":"body","7":"body","9":"is_error_response"}}
...
```python {"names":{"1":"test_flickr_api","2":"cassette_name"}}
...
```python {"names":{"3":"flickr_api","4":"cassette_name","12":"client"}}
@pytest.fixture
...
```python {"names":{"1":"test_flickr_api_without_boilerplate","2":"flickr_api","3":"resp"}}
