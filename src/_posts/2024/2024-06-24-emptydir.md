---
layout: post
date: 2024-06-24 13:46:58 +00:00
...
index:
  feature: true
card_attribution: https://www.pexels.com/photo/orange-crab-in-shallow-photo-584501/
---
...
```rust {"names":{"1":"walkdir","2":"WalkDir","3":"directories","8":"e","12":"e","16":"dir"}}
use walkdir::WalkDir;
...
```rust {"names":{"1":"directories","7":"e","11":"e"}}
let directories = WalkDir::new(".")
    .contents_first(true)
    .into_iter()
    .filter_map(|e| e.ok())
...
```rust {"names":{"1":"std","2":"collections","3":"HashSet","4":"std","5":"ffi","6":"OsString","7":"std","8":"fs","9":"std","10":"io","11":"std","12":"path","13":"Path","14":"get_names_in_directory","15":"dir","21":"names","24":"entry"}}
...
```rust {"names":{"1":"can_be_deleted","2":"path","4":"deletable_names","16":"names","20":"names"}}
...
```rust {"names":{"1":"directories_to_delete","7":"e","11":"e","16":"e"}}
