# Provides a filter that adds non-breaking spaces to text.
#
...
module Jekyll
  module AddNonBreakingSpacesFilter
    def add_non_breaking_spaces(text)
      AddNonBreakingSpaces.add_non_breaking_spaces(text)
    end
  end
end

Liquid::Template.register_filter(Jekyll::AddNonBreakingSpacesFilter) if defined? Liquid
