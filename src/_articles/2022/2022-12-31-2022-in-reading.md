---
layout: article
date: 2022-12-31 18:47:55 +00:00
...
<link href="css/components/end_of_year_books.css" rel="stylesheet"/>
...
<div
  ...
  %}
    {% include "partials/book_info.html" %}
  {% endwith %}
</div>
...
<div
  ...
  {%
    with book = {
      ...
      "review_url": "https://books.alexwlchan.net/reviews/before-the-coffee-gets-cold-tales-from-the-cafe/",
...
<div
  ...
  {%
    with book = {
      ...
      "review_url": "https://books.alexwlchan.net/reviews/rust/",
