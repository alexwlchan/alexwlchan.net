---
layout: article
date: 2025-09-18 21:14:29 +00:00
...
1.  **Work out where the dev branch diverges from main.**
...
2.  **Get a list of files which have changed in the dev branch.**
...
3.  **Open the files in our text editor.**
