...
{% update date="2025-02-19" %}
  Like this idea? You might want to check out my follow-up article [How I create static websites for tiny archives](/2025/mildly-dynamic-websites/) which explains the code in much more detail.
{% endupdate %}
