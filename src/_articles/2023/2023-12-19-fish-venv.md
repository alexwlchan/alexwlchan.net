...
```fish {"names":{"1":"PIP_REQUIRE_VIRTUALENV"}}
...
<h2 id="create-function">A function to create and auto-enable new virtual environments</h2>
...
```fish {"names":{"1":"venv","3":"line_to_append","4":"target_file"}}
...
```fish {"names":{"1":"auto_activate_venv","2":"REPO_ROOT"}}
