...
```typescript {"names":{"1":"ScheduledEvent","2":"start","3":"end","4":"getDuration","5":"ev","6":"milliseconds","16":"ev","23":"jsonifiedEvent","27":"parsedEvent"}}
type ScheduledEvent = {
  start: Date;
  end: Date;
}
...
```typescript {"names":{"1":"fixDatesInScheduledEvent","2":"ev","12":"jsonifiedEvent","16":"parsedEvent","20":"fixedEvent"}}
...
```typescript {"names":{"1":"ScheduledEvent","2":"DateType","5":"jsonifiedEvent","9":"parsedEvent","13":"fixedEvent"}}
...
```typescript {"names":{"1":"replacer","2":"key","3":"value"}}
...
```typescript {"names":{"1":"reviver","2":"key","3":"value"}}
