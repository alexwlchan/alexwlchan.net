...
```python {"names":{"1":"keyring","2":"get_password","3":"requests_oauthlib","4":"OAuth1Session","5":"credentials","10":"twitter_session"}}
...
```python {"names":{"1":"get_tweet","2":"twitter_session","3":"tweet_id","4":"resp","13":"tweet"}}
...
```python {"names":{"1":"hyperlink","2":"get_tweet_id","3":"url","4":"u","15":"tweet_id","26":"tweet_id"}}
import hyperlink
...
```python {"names":{"1":"render_tweet","2":"tweet","3":"user","5":"tweet_id","7":"tweet_text","9":"url","12":"lines","14":"tweet_line"}}
...
```python {"names":{"1":"render_tweet","2":"tweet","3":"all_entities","10":"entity","17":"tweet_line"}}
def render_tweet(tweet):
    ...
...
```python {"names":{"1":"sys","2":"hyperlink","3":"keyring","4":"get_password","5":"requests_oauthlib","6":"OAuth1Session","7":"create_twitter_session","8":"credentials","15":"get_tweet","16":"twitter_session","17":"tweet_id","18":"resp","27":"get_tweet_id","28":"url","29":"u","40":"tweet_id","51":"render_tweet","52":"tweet","53":"user","55":"tweet_id","57":"tweet_text","59":"url","62":"lines","64":"all_entities","71":"entity","78":"tweet_line","86":"tweet_url","92":"twitter_session","94":"tweet_id","97":"tweet"}}
import sys
