...
As I was writing this command, I had a vague memory of the `--write-out` flag -- it's one of Daniel Stenberg's  ["personal favourites"](https://daniel.haxx.se/blog/2023/08/01/curl-write-out-to-files/) and I wrote about using it in [a TIL in May](/notes/2024/get-info-about-curl-download/).
