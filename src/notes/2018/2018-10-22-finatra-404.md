...
```scala {"names":{"1":"com","2":"twitter","3":"finagle","4":"http","5":"Request","6":"Response","7":"com","8":"twitter","9":"finatra","10":"http","11":"Controller","12":"HttpServer","13":"com","14":"twitter","15":"finatra","16":"http","17":"routing","18":"HttpRouter","19":"CustomController","21":"get","22":"request","28":"Server","30":"configureHttp","31":"router","36":"ServerMain"}}
...
*   When I'm struggling to work out how to do something, searching GitHub for other people who've done the same thing is often fruitful.
    ...
    ```scala {"names":{"1":"ExampleApp","3":"notFound","4":"request"}}
...
```scala {"names":{"1":"CustomController","3":"get","4":"request","10":"get","11":"request"}}
class CustomController() extends Controller {
  get("/greeting") { request: Request =>
    response.ok.json(Map("hello" -> "world"))
  }
