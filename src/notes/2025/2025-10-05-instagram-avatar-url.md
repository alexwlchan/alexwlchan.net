...
date_updated: 2026-02-27 23:03:27 +00:00
...
*   If you get an HTTP 401 Unauthorized because Instagram doesn't allow anonymous requests to this endpoint, log in to Instagram in your browser and then use the `--cookies-from-browser` flag.
    For example:
    
    ```console
    $ gallery-dl --get-urls https://www.instagram.com/alexwlchan/avatar --cookies-from-browser firefox
    [cookies][info] Extracted 1594 cookies from Firefox
    https://instagram.flhr1-1.fna.fbcdn.net/v/t51.2885-19/319337386_1…
    ```

*   This avatar isn't the highest-resolution available -- for example, my avatar is 700&times;700 pixels in my web browser, but gallery-dl only finds an avatar that's 320&times;320 pixels.
