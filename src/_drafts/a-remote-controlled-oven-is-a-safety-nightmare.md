...
The blog post got a lot of attention on Twitter over the weekend, and in particular a design exercise where you design an oven that doesn't have any buttons:
...
This is a topic [I've written about in the past][assume_worst_intent] -- even if our product or service is bug-free, a malicious or abusive user might be able to use it to hurt someone.
...
How many ways can you think of how an abusive ex or terrible flatmate might use this oven to hurt someone?
...
-   Do you need more granular permissions than "can or can't control the oven"?
    Maybe you don't trust your children to turn the oven on, but you do want to let them turn it off in an emergency.
...
Access control is extremely hard to do well -- both the design of permissions system, and an interface that means users can understand it and configure it for their needs.



## What happens when somebody moves out?

The people in a household change over time: a partner moves in, a flatmate moves out, somebody crashes with you while they're between flats.
...
-   Can you block them from using the oven after they're gone?
    Conversely, could they block *you* from using, even though you're the person who still lives there?
...
What if somebody malicious gets control of the oven?
...
-   There are plenty of horror stories about bad landlords, who neglect or rip off their tenants.
...
-   Consider somebody sneaky: they still have access to the oven, but they never actually take control -- they just use the app to see when the oven is turned on.
    If you're a responsible home owner and don't leave the oven on when you're out, the oven status gives them a strong indicator of when you're at home.

    If the oven is equipped with sensors that tell it what sort of food it's cooking, and that information is displayed in the app, it might even tell them how many people are home -- and in particular, whether somebody is home alone.

-   Somebody could change the temperature of the oven while it's cooking, affecting the food inside.
    You could end up with a burnt meal -- the food is wasted, but at least it's obvious something has gone wrong.
    If they're more subtle, they could program the oven to undercook the food, but do so in a non-obvious way.
...
The reality is different: there are bad people in the world, who do bad things, and if you have a sufficiently large user base, some of your users will be bad people.
...
Most of us aren't building internet-connected ovens, so the specific ideas in this post aren't immediately practical.
...
If you're building any sort of product or service, these are things you need to think about.
Safety can't be an afterthought -- people can and will use the things we build for evil, and we need to anticipate that in advance.
